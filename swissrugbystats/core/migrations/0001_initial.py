    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type',
                 models.CharField(max_length=1, choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')])),
                ('guest', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING,
                                            db_constraint=False, blank=True, to='core.GameParticipation', null=True)),
                ('history_user', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.SET_NULL,
                                                   to=settings.AUTH_USER_MODEL, null=True)),
                ('host', models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING,
                                           db_constraint=False, blank=True, to='core.GameParticipation', null=True)),
            ],
            options={
                'ordering': ('-history_date', '-history_id'),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING,
                                    db_constraint=False, blank=True, to='core.Team', null=True),
        ...
        migrations.AddField(
            ...
            name='referee',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING,
                                    db_constraint=False, blank=True, to='core.Referee', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='historicalgame',
        ...
        migrations.AddField(
            ...
            name='venue',
            field=models.ForeignKey(related_name='+', on_delete=django.db.models.deletion.DO_NOTHING,
                                    db_constraint=False, blank=True, to='core.Venue', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='game',
            name='guest',
            field=models.ForeignKey(related_name='guestTeam_set', verbose_name=b'Guest Participation',
                                    to='core.GameParticipation', on_delete=DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='game',
            name='host',
            field=models.ForeignKey(related_name='hostTeam_set', verbose_name=b'Host Participation',
                                    to='core.GameParticipation', on_delete=DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='favorite',
            name='team',
            field=models.ForeignKey(related_name='Team', verbose_name=b'Team', to='core.Team', on_delete=DO_NOTHING),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='favorite',
